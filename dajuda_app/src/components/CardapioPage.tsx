...
const CardapioPage: React.FC = () => {
  ...
  const handleAddNewItem = async (e: React.FormEvent) => {
    ...
    if (insertError) {
      ...
      // fetchItensCardapio('add new item'); // O Realtime deve cuidar disso
    }
  };
  ...
  const handleDeleteItem = async () => {
    ...
    if (deleteError) {
      ...
      // fetchItensCardapio('delete item'); // O Realtime deve cuidar disso
    }
  };
  ...
  const handleSaveAllChanges = async () => {
    ...
    try {
      ...
      if (errors.length > 0) {
        ...
        // fetchItensCardapio('save all changes'); // O Realtime deve cuidar disso
      }
    } catch (e) {
